...
ModelName =  ["EEGNet", "DeepConvNet", "EEGInception", "PLNet", "HDCA", "xDAWNRG", "rLDA","TimesNet"]
ModelType = [True, True, True, True, False, False, False, False,True],#这里ModelType的布尔型只代表该方法是不是传统算法
Model = [EEGNet(NUMCLASSES), DeepConvNet(NUMCLASSES), EEGInception(NUMCLASSES), 
         PLNet(NUMCLASSES), HDCA(NUMCLASSES), xDAWNRG(NUMCLASSES), rLDA(NUMCLASSES),TimesNet(NUMCLASSES)]
